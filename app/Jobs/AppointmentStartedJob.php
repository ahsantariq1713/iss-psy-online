...
use App\Notifications\AppointmentStartedNotification;
...
class AppointmentStartedJob implements ShouldQueue
{
    ...
    {
        $notification = new AppointmentStartedNotification($this->appointment, $user);
