<div>
    ...
    <section class="position-relative pb-5 bg-light">
        ...
        <div class="container position-relative">
            <div class="row">
                <div class="col-12">
                    <h4 class="text-center text-sm-left mb-3"><a class="text-decoration-none text-dark" href="/search"><span class="mdi mdi-arrow-left"></span></a>
                        More about
                        {{$therapist->name}}</h4>
                </div>
                <div class="card">
                    <div class="row">
                        <div class="col-12 col-md-4 col-lg-4 py-4 pr-0 border-right">
                            <section class="px-3 d-flex justify-content-between">
                                ...
                                <div class="h3 font-weight-normal text-right">
                                    ...
                                    <i class="mdi mdi-star text-warning"></i><span class="text-muted">{{$therapist->rating()}}</span>
                                </div>
                            </section>
                            @php
                                $available = $therapist->getBookingCalendar()['available'];
                            @endphp
                            <section class="px-1 mt-3 text-center pb-6 mb-3">
                                <img src="{{ asset($therapist['avatar']) }}" class="rounded-circle" height="130" width="130" alt="">
                                ...
                                @if(not_null($therapist->license->video_url))
                                    <iframe class="position-absolute-center" style="width:200px;height:106px;z-index:9; top:390px;" disabled=""
                                            src="{{$therapist->license->video_url}}">
                                    </iframe>
                                    <div class="position-absolute bg-transparent" style="z-index:10;cursor: pointer;width:200px;height:106px; top:390px;left:65px"
                        ...
                        <div class="col-12 col-md-8 col-lg-8 pl-0">
                            ...
                            <section class="border-bottom py-4 pl-3 pr-4 ml-sm-2 ml-md-0 ml-lg-0">
                                <section class="mb-3">
                                    ...
                                    <p class="text-muted mb-1" style="font-size: 13px">{{$therapist->license->about}}</p>
                                    <a href="more-about-therapist/{{$therapist->id}}" class="text-primary mb-0">More about {{$therapist->name}}</a>
                                </section>
                                ...
                                <div class="d-flex justify-content-start">
                                    ...
                                    <span class="mt-1 ml-2"> {{$therapist->experienceYears()}} Years Experience</span>
                                </div>
                                <div class="d-flex justify-content-start">
                                ...
                                <div class="d-flex justify-content-start">
                                    ...
                                    <span class="mt-1" style="font-size:14px;color:black"> {{$therapist->country}}</span>
                                </div>
                            </section>
                            <section class="py-4 pl-3 pr-4  ml-sm-2 ml-md-0 ml-lg-0">
                            ...
                            <section class="pb-4 pl-3 pr-4  ml-sm-2 ml-md-0 ml-lg-0">
                                <h6 class="font-weight-normal">Languages</h6>
                                <span class="badge badge-sm badge-subtle badge-primary mr-2 py-2 rounded-0"
                                      style="border-radius: 50px">Abuse Physical</span>
                                <span class="badge badge-sm badge-light mr-2 py-2 rounded-0"
                                      style="border-radius: 50px">Abuse Emotional</span>
                            </section>
                            <section class="border-top pt-4 pl-3 pr-4  ml-sm-2 ml-md-0 ml-lg-0 pb-0">
                                <h6 class="font-weight-normal">Education</h6>
                                <ul class="timeline">
                                    @foreach ($therapist->educations->sortByDesc('year') as $education)
                                        <li class="timeline-item">
                                            <div class="timeline-figure">
                                                <span class="tile tile-circle tile-sm"></span>
                                            </div>
                                            <div class="timeline-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h6 class="timeline-heading">
                                                            <span  class="text-link">{{$education->degree}} - {{$education->specialization}}</span>
                                                        </h6>
                                                        <p class="mb-0">
                                                            {{$education->institute}} </p>
                                                        <p class="timeline-date d-sm-none"> {{$education->year}} </p>
                                                    </div>
                                                    <div class="d-none d-sm-block">
                                                        <span class="timeline-date">{{$education->year}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <section class="py-4  pl-3 pr-4  pt-0  ml-sm-2 ml-md-0 ml-lg-0">
                                <h6 class="font-weight-normal">Experience</h6>
                                <ul class="timeline">
                                    @foreach ($therapist->experiences->sortByDesc('start') as $experience)
                                        <li class="timeline-item">
                                            <div class="timeline-figure">
                                                <span class="tile tile-circle tile-sm"></span>
                                            </div>
                                            <div class="timeline-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h6 class="timeline-heading">
                                                            <span  class="text-link">{{$experience->designation}}</span>
                                                        </h6>
                                                        <p class="mb-0">
                                                            {{$experience->location}} </p>
                                                        <p class="timeline-date d-sm-none"> {{$experience->start_year}} </p>
                                                    </div>
                                                    <div class="d-none d-sm-block">
                                                        <span class="timeline-date">{{$experience->start}} - {{$experience->end}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
    ...
    <div class="modal fade bd-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog" id="video-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg mt-5">
            <div class="modal-content bg-transparent border-0">
                <div class="modal-header p-0">
                    <iframe id="video-frame" class="w-100" style="min-height:500px;border:0px"
                            src="">
                    </iframe>
                    <button id="close-btn" type="button" class="btn btn-icon bg-light ml-2" data-dismiss="modal" aria-label="Close" style="margin-top:-20px;margin-right:-15px">
